...
public class PlayerUtils {
    ...
    public static String getUUIDFromPlayerName(String playerName) {
        ...
        Collection<NetworkPlayerInfo> playerInfoMap =
        ...
        for (NetworkPlayerInfo networkPlayerInfo : playerInfoMap) {
            if (networkPlayerInfo.getGameProfile().getName().equalsIgnoreCase(playerName)) {
                return networkPlayerInfo.getGameProfile().getId().toString().replace("-", "");
            }
        }
    ...
    public static String getTabDisplayName(String playerName) {
        ScorePlayerTeam playerTeam =
                Minecraft.getMinecraft().theWorld.getScoreboard().getPlayersTeam(playerName);
        if (playerTeam == null) {
            return playerName;
        }
